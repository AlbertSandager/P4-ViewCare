// ======================================================================
// Lesson4.v generated from TopDesign.cysch
// 03/27/2019 at 10:20
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d0d23e3c-feb7-40b1-9bcf-c010c7d69a54"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3bf39006-af12-4797-acac-929909253f85"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_37)
    begin
        cy_tff_1 <= Net_27^Net_30;
    end
    assign Net_30 = cy_tff_1;
    // -- TFF End --
	...
	cy_clock_v1_0
		#(.id("13dd5f73-ecc4-40f9-a822-09a4856826ba"),
		  .source_clock_id(""),
		  .divisor(0),
