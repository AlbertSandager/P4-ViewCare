// ======================================================================
// UART_Full_Duplex01.v generated from TopDesign.cysch
// 03/29/2019 at 11:30
...
module top ;
    ...
    UART_v2_50_0 UART (
        ...
        .reset(1'b0),
        .rx(Net_102),
        .tx_interrupt(Net_103),
        .rx_interrupt(Net_104),
        .tx_data(Net_105),
        .tx_clk(Net_106),
        .rx_data(Net_108),
        .rx_clk(Net_109));
    ...
    cy_annotation_universal_v1_0 D (
        .connect({
            Net_95,
            Net_27
        })
    );
    defparam D.comp_name = "LED_v1_0";
    defparam D.port_names = "A, K";
    defparam D.width = 2;
