...
#define BS_IOPORT_3_VAL ((const uint8 CYFAR *)0x48000000u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 1024u, 0x0Eu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 13 */
		{ 2048u, 0x0Fu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_U0_BASE) },	/* TD 14 */
		{ 896u, 0x10u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_U0_BASE) },	/* TD 15 */
		{ 2304u, 0x11u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 16 */
		{ 256u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 17 */
		{ 7u, 0x13u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT3_BASE) },	/* TD 18 */
		{ 6u, 0x14u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PRTDSI_PRT12_BASE) },	/* TD 19 */
		{ 32u, 0x15u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UWRK_UWRK8_B0_BASE + 0x00000070u) },	/* TD 20 */
		{ 32u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UWRK_UWRK8_B1_BASE + 0x00000070u) },	/* TD 21 */
		{ 128u, 0x17u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_U0_BASE) },	/* TD 22 */
		{ 128u, 0x18u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_U1_BASE) },	/* TD 23 */
		{ 128u, 0x19u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_U0_BASE) },	/* TD 24 */
		{ 128u, 0x1Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_U1_BASE) },	/* TD 25 */
		{ 128u, 0x1Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_U0_BASE) },	/* TD 26 */
		{ 128u, 0x1Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_U1_BASE) },	/* TD 27 */
		{ 128u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_U0_BASE) },	/* TD 28 */
		{ 128u, 0x1Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_U1_BASE) },	/* TD 29 */
		{ 16u, 0x1Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL1_MDCLK_EN) },	/* TD 30 */
		{ 16u, 0x20u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL0_MDCLK_EN) },	/* TD 31 */
		{ 128u, 0x21u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE) },	/* TD 32 */
		{ 128u, 0x22u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE + 0x00000080u) },	/* TD 33 */
		{ 128u, 0x23u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_ROUTE_BASE + 0x00000080u) },	/* TD 34 */
		{ 128u, 0x24u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_ROUTE_BASE) },	/* TD 35 */
		{ 128u, 0x25u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_ROUTE_BASE + 0x00000080u) },	/* TD 36 */
		{ 128u, 0x26u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE) },	/* TD 37 */
		{ 128u, 0x27u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE + 0x00000080u) },	/* TD 38 */
		{ 128u, 0x28u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_ROUTE_BASE) },	/* TD 39 */
		{ 128u, 0x29u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P3_ROUTE_BASE + 0x00000080u) },	/* TD 40 */
		{ 128u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE) },	/* TD 41 */
		{ 128u, 0x2Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE + 0x00000080u) },	/* TD 42 */
		{ 128u, 0x2Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE) },	/* TD 43 */
		{ 128u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI9_BASE + 0x00000080u) },	/* TD 44 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_IOPORT_3_VAL),	/* TD 18 */
		(const void *)(BS_IOPORT_7_VAL),	/* TD 19 */
		(const void *)(BS_UWRK_B0_WRK_STATCTL_BITS_VAL),	/* TD 20 */
		...
		(const void *)(BS_UDB_1_2_1_CONFIG_VAL),	/* TD 24 */
		(const void *)(BS_UDB_1_2_0_CONFIG_VAL),	/* TD 25 */
		(const void *)(BS_UDB_1_0_0_CONFIG_VAL),	/* TD 26 */
		(const void *)(BS_UDB_1_0_1_CONFIG_VAL),	/* TD 27 */
		(const void *)(BS_UDB_1_1_1_CONFIG_VAL),	/* TD 28 */
		(const void *)(BS_UDB_1_1_0_CONFIG_VAL),	/* TD 29 */
		(const void *)(BS_UCFG_BCTL1_VAL),	/* TD 30 */
		(const void *)(BS_UCFG_BCTL0_VAL),	/* TD 31 */
		(const void *)(BS_DSISWITCH_0_0_VAL),	/* TD 32 */
		(const void *)(BS_DSI0_0_HV_ROUTING_VAL),	/* TD 33 */
		(const void *)(BS_UDB_1_0_HV_ROUTING_VAL),	/* TD 34 */
		(const void *)(BS_UDBSWITCH_1_0_VAL),	/* TD 35 */
		(const void *)(BS_UDB_2_0_HV_ROUTING_VAL),	/* TD 36 */
		(const void *)(BS_UDBSWITCH_1_1_VAL),	/* TD 37 */
		(const void *)(BS_UDB_2_1_HV_ROUTING_VAL),	/* TD 38 */
		(const void *)(BS_UDBSWITCH_1_2_VAL),	/* TD 39 */
		(const void *)(BS_UDB_2_2_HV_ROUTING_VAL),	/* TD 40 */
		(const void *)(BS_UDBSWITCH_1_3_VAL),	/* TD 41 */
		(const void *)(BS_UDB_2_3_HV_ROUTING_VAL),	/* TD 42 */
		(const void *)(BS_DSISWITCH_1_0_VAL),	/* TD 43 */
		(const void *)(BS_DSI3_0_HV_ROUTING_VAL),	/* TD 44 */
	};
	...
	CY_SET_REG16((void CYXDATA *)CYREG_PHUB_TDMEM0_ORIG_TD0, 44u*8u);	/* transfer size */
