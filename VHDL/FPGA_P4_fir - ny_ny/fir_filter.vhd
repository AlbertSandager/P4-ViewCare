...
-- Retrieval info:      <PRIVATE name = "coefficient_bit_width" value="7"  type="INTEGER"  enable="0" />
...
-- Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, C:\Users\Albert Sandager\Desktop\Filter.txt, 1.0, 3.0, 3.0, -1.0, -6.0, -7.0, 1.0, 17.0, 34.0, 42.0, 34.0, 17.0, 1.0, -7.0, -6.0, -1.0, 3.0, 3.0, 1.0"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "output_full_bits_right_of_binary_point" value="29"  type="INTEGER"  enable="1" />
-- Retrieval info:      <PRIVATE name = "coefficient_reload_bit_width" value="10"  type="INTEGER"  enable="1" />
-- Retrieval info:      <PRIVATE name = "logic_cell" value="2063"  type="INTEGER"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "filename" value="fir_filter.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: fir_filter_st.v, fir_filter_constraints.tcl, fir_filter_ast.vhd, fir_filter.vhd, fir_filter_ast.vhd, fir_filter.vhd;
-- IPFS_FILES: fir_filter.vho;
-- =========================================================
