...
# ACDS 13.1 162 win32 2019.05.14.10:47:29
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/LP100_rtl.vhd"                                  
  vhdlan -xlrm "$QSYS_SIMDIR/LP100_ast.vhd"                                  
  vhdlan -xlrm "$QSYS_SIMDIR/LP100.vhd"                                      
  vhdlan -xlrm "$QSYS_SIMDIR/LP100_tb.vhd"                                   
fi
