...
transcript on
write transcript LP1000_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity LP1000
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists LP1000.vhd]} {vcom -93 -work work LP1000.vhd}
    if {[file exists LP1000.v]} {vlog -work work LP1000.v}
    vcom -93 -work work LP1000_ast.vhd
    vcom -93 -work work LP1000_rtl.vhd
