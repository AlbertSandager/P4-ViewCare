...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/LP1000_rtl_u0_m0_wo0_cm0_lutmem.hex ./
}
...
alias com {
  ...
  vcom "$QSYS_SIMDIR/LP1000_rtl.vhd"                                 
  vcom "$QSYS_SIMDIR/LP1000_ast.vhd"                                 
  vcom "$QSYS_SIMDIR/LP1000.vhd"                                     
  vcom "$QSYS_SIMDIR/LP1000_tb.vhd"                                  
}
