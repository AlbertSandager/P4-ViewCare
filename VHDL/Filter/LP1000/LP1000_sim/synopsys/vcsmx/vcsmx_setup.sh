...
# ACDS 13.1 162 win32 2019.05.14.11:05:56
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/LP1000_rtl_u0_m0_wo0_cm0_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/LP1000_rtl.vhd"                                 
  vhdlan -xlrm "$QSYS_SIMDIR/LP1000_ast.vhd"                                 
  vhdlan -xlrm "$QSYS_SIMDIR/LP1000.vhd"                                     
  vhdlan -xlrm "$QSYS_SIMDIR/LP1000_tb.vhd"                                  
fi
