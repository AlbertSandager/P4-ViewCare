...
-- trdy	=>  Location: PIN_H19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rrdy	=>  Location: PIN_G18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- roe	=>  Location: PIN_J18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[0]	=>  Location: PIN_J16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[1]	=>  Location: PIN_C21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[2]	=>  Location: PIN_D22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[3]	=>  Location: PIN_D21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[4]	=>  Location: PIN_J17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[5]	=>  Location: PIN_H16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[6]	=>  Location: PIN_F20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_data[7]	=>  Location: PIN_F22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- busy	=>  Location: PIN_G15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- miso	=>  Location: PIN_B20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ss_n	=>  Location: PIN_F16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rx_req	=>  Location: PIN_E22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- reset_n	=>  Location: PIN_H18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- mosi	=>  Location: PIN_F19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sclk	=>  Location: PIN_G2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- st_load_trdy	=>  Location: PIN_C22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_en	=>  Location: PIN_H22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- st_load_en	=>  Location: PIN_B21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- st_load_rrdy	=>  Location: PIN_K18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- st_load_roe	=>  Location: PIN_K17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[7]	=>  Location: PIN_H20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[6]	=>  Location: PIN_F21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[5]	=>  Location: PIN_H17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[4]	=>  Location: PIN_H21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[3]	=>  Location: PIN_F14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[2]	=>  Location: PIN_E21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[1]	=>  Location: PIN_F17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[0]	=>  Location: PIN_G17,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \rx_buf[7]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \process_1~7_combout\ = (!bit_cnt(5) & (!bit_cnt(6) & (!bit_cnt(7) & !bit_cnt(16))))
...
-- Equation(s):
-- \process_1~8_combout\ = (!bit_cnt(1) & (!bit_cnt(3) & (!bit_cnt(4) & !bit_cnt(2))))
...
-- Equation(s):
-- \process_1~9_combout\ = (bit_cnt(0) & (!\rd_add~q\ & (\process_1~7_combout\ & \process_1~8_combout\)))
...
-- Equation(s):
-- \rrdy~7_combout\ = (\rrdy~2_combout\) # ((bit_cnt(16) & !\wr_add~q\))
...
-- Equation(s):
-- \miso~4_combout\ = (bit_cnt(10) & (!bit_cnt(9) & !bit_cnt(8))) # (!bit_cnt(10) & (bit_cnt(9) $ (bit_cnt(8))))
...
\rx_buf[7]~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \rx_buf[7]~feeder_combout\ = \rx_buf[7]~7_combout\
...
-- pragma translate_on
PORT MAP (
	datac => \rx_buf[7]~7_combout\,
	combout => \rx_buf[7]~feeder_combout\);
