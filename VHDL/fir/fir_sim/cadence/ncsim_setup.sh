...
# ACDS 13.1 162 win32 2019.05.08.08:38:32
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/fir_rtl.vhd"                                    
  ncvhdl -v93 "$QSYS_SIMDIR/fir_ast.vhd"                                    
  ncvhdl -v93 "$QSYS_SIMDIR/fir.vhd"                                        
  ncvhdl -v93 "$QSYS_SIMDIR/fir_tb.vhd"                                     
fi
