...
transcript on
write transcript LP10_transcript
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists LP10.vhd]} {vcom -93 -work work LP10.vhd}
    if {[file exists LP10.v]} {vlog -work work LP10.v}
    vcom -93 -work work LP10_ast.vhd
    vcom -93 -work work LP10_rtl.vhd
