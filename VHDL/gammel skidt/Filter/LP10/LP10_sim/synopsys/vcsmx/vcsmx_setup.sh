...
# ACDS 13.1 162 win32 2019.05.14.12:41:21
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/LP10_rtl.vhd"                                   
  vhdlan -xlrm "$QSYS_SIMDIR/LP10_ast.vhd"                                   
  vhdlan -xlrm "$QSYS_SIMDIR/LP10.vhd"                                       
  vhdlan -xlrm "$QSYS_SIMDIR/LP10_tb.vhd"                                    
fi
