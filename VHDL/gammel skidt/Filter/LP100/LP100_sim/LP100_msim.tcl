...
transcript on
write transcript LP100_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity LP100
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists LP100.vhd]} {vcom -93 -work work LP100.vhd}
    if {[file exists LP100.v]} {vlog -work work LP100.v}
    vcom -93 -work work LP100_ast.vhd
    vcom -93 -work work LP100_rtl.vhd
