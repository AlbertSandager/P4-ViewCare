...
-- trdy	=>  Location: PIN_AB16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- rrdy	=>  Location: PIN_AA17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- roe	=>  Location: PIN_Y13,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- busy	=>  Location: PIN_U11,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- rx_req	=>  Location: PIN_AA16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- reset_n	=>  Location: PIN_W14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- st_load_trdy	=>  Location: PIN_AA15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_en	=>  Location: PIN_V14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- st_load_en	=>  Location: PIN_U13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- st_load_rrdy	=>  Location: PIN_AB17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- st_load_roe	=>  Location: PIN_W13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[7]	=>  Location: PIN_R13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[6]	=>  Location: PIN_AB18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[5]	=>  Location: PIN_W15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[4]	=>  Location: PIN_T12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[3]	=>  Location: PIN_V13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[2]	=>  Location: PIN_Y17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[1]	=>  Location: PIN_AA19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- tx_load_data[0]	=>  Location: PIN_T14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \process_1~7_combout\ = (!bit_cnt(7) & (!bit_cnt(6) & (!bit_cnt(5) & !bit_cnt(16))))
...
-- Equation(s):
-- \process_1~9_combout\ = (\process_1~8_combout\ & (!\rd_add~q\ & \process_1~7_combout\))
