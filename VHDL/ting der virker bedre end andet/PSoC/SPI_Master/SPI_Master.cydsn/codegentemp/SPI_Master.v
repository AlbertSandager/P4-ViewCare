...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f947dd05-5100-496f-9078-db3d64729239"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_1 SPIM (
        ...
        .clock(Net_11),
        .reset(1'b0),
        .rx_interrupt(Net_137),
        .sdat(Net_104),
        .tx_interrupt(Net_172));
	...
	cy_psoc3_pins_v1_10
		#(.id("f3b2c0ce-48c9-48d9-a7b5-62379ea7aee3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9ab4a0fa-8c7f-4db5-9fef-de2bf5ac7a86"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
